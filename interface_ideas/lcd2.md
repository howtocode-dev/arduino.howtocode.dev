...
প্রোগ্রামগুলো এত সহজ হওয়ার কারণ মূলত ওই লাইব্রেরি। ওপেন-সোর্সের মজা মূলত এখানেই, নিজের ইচ্ছামত সবকিছু ভেঙ্গে গুঁড়িয়ে আবার নতুন করে শুরু করা যায়। Code Reusability এর ক্ষেত্রে লাইব্রেরির জুড়ি নেই।
...
* `MyLibrary` ফোল্ডার: এই ফোল্ডারে আপনার লাইব্রেরির প্রয়োজনীয় ফাইলগুলো থাকবে
  ...
  * অন্যান্য _.h ও_ .cpp ফাইল \[MyLibrary/Others.h, MyLibrary/Others.cpp\]: আপনার তৈরি লাইব্রেরি যদি অন্য কোন লাইব্রেরি / ক্লাস বা মেথড নির্ভরশীল হয় তাহলে সে ফাইলগুলো আপনার লাইব্রেরির ফোল্ডারে রেখে দেবেন। 
...
![create\_dir](http://i.imgur.com/X1R4Obb.jpg)
...
![important\_files](http://i.imgur.com/x6IvdJn.png)
...
![added\_new\_files](http://i.imgur.com/BpyCzzk.png)
...
![img1](http://i.imgur.com/cwD4crv.png) ![img2](http://i.imgur.com/kNYMs3E.png) ![img3](http://i.imgur.com/5k2ORUm.png) ![img4](http://i.imgur.com/EbjAFvj.png)
...
হেডার ফাইল তৈরি করার পরে সোর্স ফাইলে সেই ফাংশনগুলোর লজিক বসাতে হয়। এখানে আমরা যেসব মেথড ইম্প্লিমেন্ট করব, প্রত্যেকটি MyLiquidCrystal ক্লাসের। OOP এর স্ট্রাকচার অনুযায়ী, কোন ক্লাসের মেথড যদি Out of Class ইম্প্লিমেন্ট করতে হয় তাহলে তাকে এভাবে লিখতে হয়: `return_type className :: (scope_resolution_operator) functionName(argument)`
...
লাইব্রেরিটি জিপ করুন। তারপর Arduino IDE ওপেন করে Sketch &gt; Import Library &gt; your\_library.zip সিলেক্ট করুন।

![add\_lib](http://i.imgur.com/RCAlwXY.gif)
...
![library\_working](http://i.imgur.com/43WLOfy.gif)

### বাড়ির কাজ:

আমার তৈরি করা লাইব্রেরিতে কয়েকটি সমস্যা আছে। তার মধ্যে দুইটি সল্ভ করতে হবে,

১। word\_scroll মেথডটিতে আমি while\(true\) বা একটি Infinite loop ব্যবহার করেছি। আপনাকে এমনভাবে লাইব্রেরিকে মডিফাই করতে হবে যেন আমি word\_scroll মেথড টা কন্ট্রোল করতে পারি। অর্থাৎ, infinite loop ব্যবহার না করে স্ক্রলিং কন্ট্রোল করতে হবে। আপনি ইচ্ছা করলে Button, Serial ইত্যাদি সবকিছু ব্যবহার করে এটা করতে পারেন। মানে আপনার সল্যুশনটা সফটওয়্যার বা হার্ডওয়্যার যেকোন ভিত্তিক হতে পারে।

২। একটা জিনিস খেয়াল করেছেন, word\_scroll মেথডটা তখনই কাজ করবে যখন শব্দের দৈর্ঘ্য LCD এর কলামের দৈর্ঘ্যের চেয়ে ছোট। আপনাকে এটাকে এমনভাবে মডিফাই করতে হবে যেন এই ফাংশনটি সব আকারের স্ট্রিং বা শব্দের জন্য কাজ করে।
